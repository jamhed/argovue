...
func (c *FakeServices) Get(ctx context.Context, name string, options v1.GetOptions) (result *argovueiov1.Service, err error) {
	obj, err := c.Fake.
...
func (c *FakeServices) List(ctx context.Context, opts v1.ListOptions) (result *argovueiov1.ServiceList, err error) {
	obj, err := c.Fake.
...
func (c *FakeServices) Create(ctx context.Context, service *argovueiov1.Service, opts v1.CreateOptions) (result *argovueiov1.Service, err error) {
	obj, err := c.Fake.
...
func (c *FakeServices) Update(ctx context.Context, service *argovueiov1.Service, opts v1.UpdateOptions) (result *argovueiov1.Service, err error) {
	obj, err := c.Fake.
...
func (c *FakeServices) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *argovueiov1.Service, err error) {
	obj, err := c.Fake.
