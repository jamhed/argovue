...
type DatasetInterface interface {
	...
	Get(name string, options metav1.GetOptions) (*v1.Dataset, error)
	List(opts metav1.ListOptions) (*v1.DatasetList, error)
...
func newDatasets(c *ArgovueV1Client, namespace string) *datasets {
	return &datasets{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *datasets) Get(name string, options metav1.GetOptions) (result *v1.Dataset, err error) {
	result = &v1.Dataset{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("datasets").
...
func (c *datasets) List(opts metav1.ListOptions) (result *v1.DatasetList, err error) {
...
func (c *datasets) Watch(opts metav1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *datasets) Delete(name string, options *metav1.DeleteOptions) error {
...
func (c *datasets) DeleteCollection(options *metav1.DeleteOptions, listOptions metav1.ListOptions) error {
	var timeout time.Duration
